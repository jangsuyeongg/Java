package Vo.Professor;

public class ProfessorModeVO2 {
	private int Prof_Code;
	private int Major_Code;
	private String prof_pw;
	private String prof_name;
	private String prof_email;
	private int prof_tel;
	private String prof_room;
	private int prof_hd;
	private int prof_birth;	
	

	public ProfessorModeVO2() {
	...
	public int getProf_tel() {
		return prof_tel;
	}


	public void setProf_tel(int prof_tel) {
	...
	public int getProf_hd() {
		return prof_hd;
	}


	public void setProf_hd(int prof_hd) {
		this.prof_hd = prof_hd;
	}


	public int getProf_birth() {
		return prof_birth;
	}


	public void setProf_birth(int prof_birth) {
